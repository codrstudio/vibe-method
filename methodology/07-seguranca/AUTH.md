...
1. [Autenticacao HTTP-Only Cookie](#autenticacao-http-only-cookie) - JWT seguro
2. [Autenticacao Multi-Etapas](#autenticacao-multi-etapas) - Login progressivo
3. [Redirect Apos Login](#redirect-apos-login) - Deep linking
4. [Arquitetura Multi-Contexto](#arquitetura-multi-contexto) - Equipe vs Cliente
5. [Avatar Upload](#avatar-upload) - Crop circular
6. [Area de Seguranca](#area-de-seguranca) - Alteracao de senha
7. [Estrutura de Arquivos](#estrutura-de-arquivos) - Organizacao
8. [Boas Praticas](#boas-praticas) - Recomendacoes
...
7. **Full page refresh**: Apos login para garantir cookie
...
### Multi-Contexto (se aplicavel)
- [ ] Cookies separados (team/customer)
- [ ] Middleware multi-contexto
- [ ] LoginForm parametrizavel
