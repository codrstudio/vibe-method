...
- [../07-seguranca/AUTH.md](../07-seguranca/AUTH.md) - Autenticacao, login multi-etapas, redirect
- [../07-seguranca/PERMISSIONS.md](../07-seguranca/PERMISSIONS.md) - Controle de acesso, protecao de rotas

---

## Indice

1. [Principio Fundamental](#principio-fundamental) - URL-First Navigation
2. [Estrutura de Pastas](#estrutura-de-pastas) - Organizacao do App Router
3. [Padroes de URL](#padroes-de-url) - Paginas e API Routes
4. [Query Parameters](#query-parameters) - Filtros, modais, paginacao
5. [Encoding de URLs](#encoding-de-urls) - Espacos e caracteres especiais
6. [Auth com Redirect](#auth-com-redirect) - Deep Linking
7. [Implementacoes](#implementacoes) - Exemplos completos
8. [Route Groups](#route-groups) - Organizacao por dominio
9. [Anti-patterns](#anti-patterns) - O que evitar
...
```typescript
// ERRADO: Tab component gerenciando state
<Tabs value={tab} onChange={setTab}>

// ERRADO: Renderizacao condicional por state
{activeSection === 'security' && <SecurityForm />}

// ERRADO: Query params para navegacao principal
/settings?tab=security

// ERRADO: Hash navigation
/settings#security

// ERRADO: Encoding com %20
/docs/Guia%20de%20Uso
```

**CERTO:**
- Tabs sao subpastas: `/settings/security`
- Cada tela tem `page.tsx` proprio
- Espacos codificados como `+`: `/docs/Guia+de+Uso`
