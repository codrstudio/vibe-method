...
- [BRAND.md](./BRAND.md) - Sistema de identidade visual e tokens

---

## Indice

1. [Por que Next.js](#por-que-nextjs) - Justificativa
2. [Stack Base](#stack-base) - Tecnologias
3. [Estrutura de Rotas](#estrutura-de-rotas) - Organizacao do App Router
4. [Configuracao](#configuracao-nextjs) - next.config.ts e middleware
5. [PWA com Serwist](#pwa-com-serwist) - Service Worker e manifest
6. [Install Prompt](#install-prompt) - Componente de instalacao
7. [Responsividade](#responsividade) - Mobile-first e safe areas
8. [SEO](#seo) - Metadata e Schema.org
9. [Data Fetching](#data-fetching) - TanStack Query
10. [Verificacao](#verificacao) - Checklists
