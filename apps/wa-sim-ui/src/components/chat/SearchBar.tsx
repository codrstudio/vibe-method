...
export function SearchBar({ contactId, onClose, onNavigateToMessage }: SearchBarProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border-b border-wa-border dark:border-gray-600">
      ...
      <input
        ...
        className="flex-1 bg-transparent text-sm outline-none text-wa-text-primary dark:text-white placeholder:text-wa-text-secondary"
        autoFocus
      />
      ...
      {matches.length > 0 && (
        <>
          <button
            ...
            className="p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-700 text-wa-text-secondary"
            title="Anterior"
          >
